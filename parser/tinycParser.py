...
class tinycParser ( Parser ):
    ...
    class ExprContext(ParserRuleContext):
        ...
        def exp_id(self):
            return self.getTypedRuleContext(tinycParser.Exp_idContext,0)
    ...
    class TestContext(ParserRuleContext):
        ...
        def sta_sum(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(tinycParser.Sta_sumContext)
            else:
                return self.getTypedRuleContext(tinycParser.Sta_sumContext,i)
    ...
    class Sta_sumContext(ParserRuleContext):
        ...
        def sta_sum(self):
            return self.getTypedRuleContext(tinycParser.Sta_sumContext,0)


        def getRuleIndex(self):
            return tinycParser.RULE_sta_sum

        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterSta_sum" ):
                listener.enterSta_sum(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitSta_sum" ):
                listener.exitSta_sum(self)



    def sta_sum(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = tinycParser.Sta_sumContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 10
        self.enterRecursionRule(localctx, 10, self.RULE_sta_sum, _p)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 76
            self.term()
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = tinycParser.Sta_sumContext(self, _parentctx, _parentState)
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_sta_sum)
                        self.state = 78
    ...
    class Exp_idContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return tinycParser.RULE_exp_id

        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterExp_id" ):
                listener.enterExp_id(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitExp_id" ):
                listener.exitExp_id(self)
    ...
    def exp_id(self):
        ...
        localctx = tinycParser.Exp_idContext(self, self._ctx, self.state)
        self.enterRule(localctx, 14, self.RULE_exp_id)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 94
    ...
    def sempred(self, localctx:RuleContext, ruleIndex:int, predIndex:int):
        ...
        self._predicates[5] = self.sta_sum_sempred
    ...
    def sta_sum_sempred(self, localctx:Sta_sumContext, predIndex:int):
            if predIndex == 0:
